...
* **Rank Hysteresis (Buffer Zones):** Introduce a hold threshold in your backtest. If a stock is currently in your Top 50, you do not sell it unless its rank drops below a much lower threshold (e.g., Rank 75 or 100). This drastically reduces noise-driven churning while keeping your capital in high-probability assets.
* **Multi-Day Forecasting:** Instead of predicting tomorrow's return ($t+1$), shift your training targets to predict the return over the next 5 or 10 days. This naturally smooths the predictions and forces the model to look for structural trends rather than 24-hour noise, inherently lowering your turnover since you intend to hold the asset longer.